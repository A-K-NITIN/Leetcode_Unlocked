<h1>4378 - Nearest Available Drone</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/nearest-available-drone/">nearest-available-drone</a></h2><p>You are given a 2D integer array <code>drones</code>, where <code>drones[i] = [x<sub>i</sub>, y<sub>i</sub>, range<sub>i</sub>]</code> represents the x-coordinate, y-coordinate, and travel range of the <code>i<sup>th</sup></code> drone.</p>
