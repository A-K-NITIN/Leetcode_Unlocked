<h1>4316 - Minimum Swaps to Move Zeros to End</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/minimum-swaps-to-move-zeros-to-end/">minimum-swaps-to-move-zeros-to-end</a></h2><p>You are given an integer array <code>nums</code>.</p>
