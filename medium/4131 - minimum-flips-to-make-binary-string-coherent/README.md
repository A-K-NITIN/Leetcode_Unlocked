<h1>4131 - Minimum Flips to Make Binary String Coherent</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-flips-to-make-binary-string-coherent/">minimum-flips-to-make-binary-string-coherent</a></h2><p>You are given a binary string <code>s</code>.</p>
