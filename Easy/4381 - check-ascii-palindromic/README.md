<h1>4381 - Check ASCII Palindromic</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-ascii-palindromic/">check-ascii-palindromic</a></h2><p>You are given a string <code>s</code> consisting of lowercase English letters.</p>
