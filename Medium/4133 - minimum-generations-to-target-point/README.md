<h1>4133 - Minimum Generations to Target Point</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/minimum-generations-to-target-point/">minimum-generations-to-target-point</a></h2><p>You are given a 2D integer array <code>points</code> where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>, z<sub>i</sub>]</code> represents a point in 3D space, and an integer array <code>target</code> representing a target point.</p>
